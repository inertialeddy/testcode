...
!------------------------------------------------------------------------!
  ...
  REAL(kind=rc_kind), dimension(    1:42752               )     ::  stressx_timeseries,stressy_timeseries 
...
REAL(kind=rc_kind), dimension(  0:NI+1,0:NJ+1,0:NK+1  ) :: psom_tke, psom_eps
REAL(kind=rc_kind), dimension(  1:NI  ,1:NJ  ,0:NK    ) :: psom_l, psom_P, psom_B  
